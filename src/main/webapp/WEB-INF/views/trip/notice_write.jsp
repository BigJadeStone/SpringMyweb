			...
			<fieldset>
				...
				<ul class="app_list">
					...
					<li class="clear"><label for="email_lbl"
						...
						<div class="app_content email_area">
							<input type="hidden" /> <input type="text" placeholder="작성자" name="writer" required="required"/>
					...
					<li class="clear"><label for="name_lbl"
						...
						<div class="app_content">
							<input type="text" class="w100p" id="name_lbl"
								placeholder="제목을 입력하세요" name="title" required="required"/>
						</div></li>


					<li class="clear"><label for="content_lbl" class="tit_lbl">문의내용</label>
						<div class="app_content">
							<textarea id="content_lbl" class="w100p" name="content"
								placeholder="간단한 상담 요청 사항을 남겨주시면 보다 상세한 상담이 가능합니다. 전화 상담 희망시 기재 부탁드립니다."
								required="required" >
							</textarea>
				...
				<!-- 	<a href="javascript:;" class="btn_baseColor">글작성</a> <a
						...
						<input type="submit" class="btn_baseColr" value="글작성">
						<input type="button" class="btn_baseColr" value="목록" onclick="location.href='notice_list'">
